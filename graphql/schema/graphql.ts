...
export type HostRoleWhereInput = {
	...
	hostCommunityRemovePostFromPublication?: InputMaybe<
		Scalars['Boolean']['input']
	>
	hostCommunityRemovePostFromPublicationNEQ?: InputMaybe<
		Scalars['Boolean']['input']
	>
...
export type RoleWhereInput = {
	...
	communityRemovePostFromPublicationNEQ?: InputMaybe<
		Scalars['Boolean']['input']
	>
	/** community_roles_management field predicates */
	communityRolesManagement?: InputMaybe<Scalars['Boolean']['input']>
...
export type GetCommunitiesQuery = {
	...
	communities: Array<{
		...
		createdAt: any
		logo?: { __typename?: 'Media'; url?: string | null } | null
		banner?: { __typename?: 'Media'; url?: string | null } | null
		owner: {
			__typename?: 'User'
			id: string
			name: string
		...
		roles?: Array<{ __typename?: 'Role'; id: string; title: string }> | null
	}>
}
...
export type GetCommunityByIdQuery = {
	__typename?: 'Query'
	community?: {
		__typename?: 'Community'
		id: string
...
export type GetHostQuery = {
	...
	host?: {
		...
		logo?: { __typename?: 'Media'; url?: string | null } | null
		banner?: { __typename?: 'Media'; url?: string | null } | null
		authBanner?: { __typename?: 'Media'; url?: string | null } | null
	} | null
}

export type GetHostSidebarNavigationQueryVariables = Exact<{
	[key: string]: never
}>

export type GetHostSidebarNavigationQuery = {
	__typename?: 'Query'
	hostSidebarNavigation?: {
		...
		items?: Array<{
			...
			id: string
			createdAt: any
			post: { __typename?: 'Post'; id: string; title: string }
		}> | null
	} | null
}

export type GetHostSocialNavigationQueryVariables = Exact<{
	[key: string]: never
}>

export type GetHostSocialNavigationQuery = {
	__typename?: 'Query'
...
export type GetHostUserBanByIdQuery = {
	__typename?: 'Query'
	hostUserBan?: {
		__typename?: 'HostUserBan'
		user: {
			...
			name: string
			slug: string
			avatar?: { __typename?: 'Media'; id: string; url?: string | null } | null
		}
	} | null
}
...
export type GetHostUsersBanQuery = {
	__typename?: 'Query'
	hostUsersBan: Array<{
		__typename?: 'HostUserBan'
		user: {
...
export type GetPostByIdQuery = {
	...
	post?: {
		...
		heroImage?: { __typename?: 'Media'; id: string; url?: string | null } | null
		author: {
			__typename?: 'User'
			id: string
			name: string
...
export type GetRoleByIdQuery = {
	...
	role?: {
		...
		badge?: { __typename?: 'Media'; url?: string | null } | null
		community: {
			__typename?: 'Community'
			id: string
			title: string
...
export type GetRolesByCommunityIdQuery = {
	__typename?: 'Query'
	roles: Array<{
		__typename?: 'Role'
		id: string
