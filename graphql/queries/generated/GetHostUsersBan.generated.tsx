...
export type GetHostUsersBanQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const GetHostUsersBanDocument = gql`
    query GetHostUsersBan {
  hostUsersBan {
    user {
      id
      name
...
/**
 * __useGetHostUsersBanQuery__
 *
 * To run a query within a React component, call `useGetHostUsersBanQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetHostUsersBanQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetHostUsersBanQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetHostUsersBanQuery(baseOptions?: Apollo.QueryHookOptions<GetHostUsersBanQuery, GetHostUsersBanQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetHostUsersBanQuery, GetHostUsersBanQueryVariables>(GetHostUsersBanDocument, options);
      }
export function useGetHostUsersBanLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetHostUsersBanQuery, GetHostUsersBanQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetHostUsersBanQuery, GetHostUsersBanQueryVariables>(GetHostUsersBanDocument, options);
        }
export function useGetHostUsersBanSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetHostUsersBanQuery, GetHostUsersBanQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetHostUsersBanQuery, GetHostUsersBanQueryVariables>(GetHostUsersBanDocument, options);
        }
export type GetHostUsersBanQueryHookResult = ReturnType<typeof useGetHostUsersBanQuery>;
export type GetHostUsersBanLazyQueryHookResult = ReturnType<typeof useGetHostUsersBanLazyQuery>;
export type GetHostUsersBanSuspenseQueryHookResult = ReturnType<typeof useGetHostUsersBanSuspenseQuery>;
export type GetHostUsersBanQueryResult = Apollo.QueryResult<GetHostUsersBanQuery, GetHostUsersBanQueryVariables>;