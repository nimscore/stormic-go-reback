...
export type GetStartedLayoutQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const GetStartedLayoutDocument = gql`
    query GetStartedLayout {
  host {
    title
    slogan
    contacts
...
/**
 * __useGetStartedLayoutQuery__
 *
 * To run a query within a React component, call `useGetStartedLayoutQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetStartedLayoutQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetStartedLayoutQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetStartedLayoutQuery(baseOptions?: Apollo.QueryHookOptions<GetStartedLayoutQuery, GetStartedLayoutQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetStartedLayoutQuery, GetStartedLayoutQueryVariables>(GetStartedLayoutDocument, options);
      }
export function useGetStartedLayoutLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetStartedLayoutQuery, GetStartedLayoutQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetStartedLayoutQuery, GetStartedLayoutQueryVariables>(GetStartedLayoutDocument, options);
        }
export function useGetStartedLayoutSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetStartedLayoutQuery, GetStartedLayoutQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetStartedLayoutQuery, GetStartedLayoutQueryVariables>(GetStartedLayoutDocument, options);
        }
export type GetStartedLayoutQueryHookResult = ReturnType<typeof useGetStartedLayoutQuery>;
export type GetStartedLayoutLazyQueryHookResult = ReturnType<typeof useGetStartedLayoutLazyQuery>;
export type GetStartedLayoutSuspenseQueryHookResult = ReturnType<typeof useGetStartedLayoutSuspenseQuery>;
export type GetStartedLayoutQueryResult = Apollo.QueryResult<GetStartedLayoutQuery, GetStartedLayoutQueryVariables>;