...
export type GetRolesByCommunityIdQueryVariables = Types.Exact<{
...
export const GetRolesByCommunityIdDocument = gql`
    query GetRolesByCommunityId($id: ID!) {
  roles(id: $id) {
    id
    title
    color
...
/**
 * __useGetRolesByCommunityIdQuery__
 *
 * To run a query within a React component, call `useGetRolesByCommunityIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetRolesByCommunityIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetRolesByCommunityIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetRolesByCommunityIdQuery(baseOptions: Apollo.QueryHookOptions<GetRolesByCommunityIdQuery, GetRolesByCommunityIdQueryVariables> & ({ variables: GetRolesByCommunityIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRolesByCommunityIdQuery, GetRolesByCommunityIdQueryVariables>(GetRolesByCommunityIdDocument, options);
      }
export function useGetRolesByCommunityIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRolesByCommunityIdQuery, GetRolesByCommunityIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRolesByCommunityIdQuery, GetRolesByCommunityIdQueryVariables>(GetRolesByCommunityIdDocument, options);
        }
export function useGetRolesByCommunityIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetRolesByCommunityIdQuery, GetRolesByCommunityIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetRolesByCommunityIdQuery, GetRolesByCommunityIdQueryVariables>(GetRolesByCommunityIdDocument, options);
        }
export type GetRolesByCommunityIdQueryHookResult = ReturnType<typeof useGetRolesByCommunityIdQuery>;
export type GetRolesByCommunityIdLazyQueryHookResult = ReturnType<typeof useGetRolesByCommunityIdLazyQuery>;
export type GetRolesByCommunityIdSuspenseQueryHookResult = ReturnType<typeof useGetRolesByCommunityIdSuspenseQuery>;
export type GetRolesByCommunityIdQueryResult = Apollo.QueryResult<GetRolesByCommunityIdQuery, GetRolesByCommunityIdQueryVariables>;